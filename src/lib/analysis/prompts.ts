  ...
  "biographies": [
    {
      "name": "人物姓名",
      "role": "叙事身份",
      "identity": "人物身份：这个人在故事世界里的社会身份、职业、地位、处境（一句话概括他是谁）",
      "personality": "人物性格：这个人的性格特质、价值观、情绪基调、与人相处的方式（一句话概括他是什么样的人）",
      "attitude": "面临事情时的态度：当遇到冲突、压力、抉择、危机时，这个人一贯的应对方式和行为倾向（一句话概括他会怎么做）",
